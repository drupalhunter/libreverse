...
#ifndef WPEF_LOAD_CONFIG_DIRECTORY_H_
#define WPEF_LOAD_CONFIG_DIRECTORY_H_
...
namespace libreverse { namespace wpef_module {
    ...
    class PE_Load_Config_Directory : public libreverse::header::Base_Header {
    public:
...
#endif /* WPEF_LOAD_CONFIG_DIRECTORY_H_ */

...
#ifndef REVERSE_IO_INPUT_FILE_READERS_WINDOWS_PE_PE_HEADER_32_HPP_INCLUDED
#define REVERSE_IO_INPUT_FILE_READERS_WINDOWS_PE_PE_HEADER_32_HPP_INCLUDED
...
namespace reverse {
  namespace io {
	...
	namespace windows_pe {
	   ...
	   */
	  class pe_header_32 : public io::input::base_header {
	  public:
	    ...
	    boost::shared_ptr < pe_optional_header_32 > get_optional_header (void) const;

	    void set_optional_header ( boost::shared_ptr < pe_optional_header_32 > o_ptr );
	  ...
	  private:
	    ...
	    /* PE Optional Header */
	    boost::shared_ptr < pe_optional_header_32 > m_opt_hdr_ptr;
...
#endif // ifndef REVERSE_IO_INPUT_FILE_READERS_WINDOWS_PE_PE_HEADER_32_HPP_INCLUDED

...
namespace libreverse { namespace wpef_module {
    ...
    void
    PE_Header_64::set_COFF_Header ( wpef_types::COFF_Header::ptr_t c_ptr )
    {
        m_coff_hdr_ptr = c_ptr;
    }

    wpef_types::PE_Optional_Header_64::ptr_t
    ...
    void
    PE_Header_64::set_Optional_Header ( wpef_types::PE_Optional_Header_64::ptr_t o_ptr )
    {
        m_opt_hdr_ptr = o_ptr;
    }

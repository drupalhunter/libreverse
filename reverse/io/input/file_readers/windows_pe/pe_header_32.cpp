...
namespace reverse {
  namespace io {
	...
	namespace windows_pe {
	  ...
	  void
	  pe_header_32::set_coff_header ( boost::shared_ptr < coff_header > c_ptr )
	  {
	    m_coff_hdr_ptr = c_ptr;
	  }

	  boost::shared_ptr < pe_optional_header_32 >
	  ...
	  void
	  pe_header_32::set_optional_header ( boost::shared_ptr < pe_optional_header_32 > o_ptr )
	  {
	    m_opt_hdr_ptr = o_ptr;
	  }

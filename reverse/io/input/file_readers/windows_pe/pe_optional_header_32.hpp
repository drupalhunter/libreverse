...
#ifndef PE_OPTIONAL_HEADER_32_H_
#define PE_OPTIONAL_HEADER_32_H_
...
namespace libreverse { namespace wpef_module {
    ...
    class PE_Optional_Header_32 : public libreverse::header::Base_Header {
    public:
...
#endif /* PE_OPTIONAL_HEADER_32_H_ */

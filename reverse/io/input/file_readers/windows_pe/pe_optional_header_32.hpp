...
#ifndef REVERSE_IO_INPUT_FILE_READER_WINDOWS_PE_PE_OPTIONAL_HEADER_32_HPP_INCLUDED
#define REVERSE_IO_INPUT_FILE_READER_WINDOWS_PE_PE_OPTIONAL_HEADER_32_HPP_INCLUDED
...
namespace reverse {
  namespace io {
	...
	namespace windows_pe {
	  ...
	  class pe_optional_header_32 : public io::input::base_header {
	  public:
	  ...
	  protected:
	    ...
	    */
	    boost::uint32_t m_size_of_stack_reserve;

	    // MS_PE_COFF: The size of the stack to commit.
	    boost::uint32_t m_size_of_stack_commit;
	    ...
	    */
	    boost::uint32_t m_size_of_heap_reserve;

	    // MS_PE_COFF: The size of the local heap to commit.
	    boost::uint32_t m_size_of_heap_commit;
...
#endif // ifndef REVERSE_IO_INPUT_FILE_READER_WINDOWS_PE_PE_OPTIONAL_HEADER_32_HPP_INCLUDED

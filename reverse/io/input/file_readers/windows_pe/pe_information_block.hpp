...
#ifndef PE_INFORMATION_BLOCK_H_
#define PE_INFORMATION_BLOCK_H_
...
namespace libreverse { namespace wpef_module {
    ...
    class PE_Information_Block : public libreverse::header::Base_Header {
    public:

...
#ifndef JAVA_FLOAT_VARIABLE_INFO_H_
#define JAVA_FLOAT_VARIABLE_INFO_H_

#include "Verification_Type_Info.h"

namespace reverse { namespace java_module {

    class Float_Variable_Info : public Verification_Type_Info {
    public:

      Float_Variable_Info ();

      virtual ~Float_Variable_Info(){}
...
#endif /* JAVA_FLOAT_VARIABLE_INFO_H_ */

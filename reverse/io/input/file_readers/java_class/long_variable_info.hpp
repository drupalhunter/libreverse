...
#ifndef JAVA_LONG_VARIABLE_INFO_H_
#define JAVA_LONG_VARIABLE_INFO_H_

#include "Verification_Type_Info.h"

namespace reverse { namespace java_module {

    class Long_Variable_Info : public Verification_Type_Info {
    public:

      Long_Variable_Info ();

      virtual ~Long_Variable_Info(){}
...
#endif /* JAVA_LONG_VARIABLE_INFO_H_ */

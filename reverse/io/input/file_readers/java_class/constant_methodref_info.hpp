...
#ifndef JAVA_CONSTANT_METHODREF_INFO_H_
#define JAVA_CONSTANT_METHODREF_INFO_H_
...
namespace libreverse { namespace java_module {
    ...
    class Constant_Methodref_Info
        : public Constant_Pool_Info,
          public boost::enable_shared_from_this<Constant_Methodref_Info>
    {
    public:
        ...
        boost::uint16_t get_Class_Index() const;

        boost::uint16_t get_Name_And_Type_Index() const;
    ...
    private:
         ...
         * representing the class type, not an interface type.
         */
         ...
         * This must be a method descriptor.
         */
...
#endif /* JAVA_CONSTANT_METHODREF_INFO_H_ */

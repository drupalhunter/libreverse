...
#ifndef JAVA_ENCLOSING_METHOD_ATTRIBUTE_H_
#define JAVA_ENCLOSING_METHOD_ATTRIBUTE_H_
...
namespace reverse { namespace java_module {
    ...
    class Enclosing_Method_Attribute
        : public Attribute_Info,
          public boost::enable_shared_from_this<Enclosing_Method_Attribute>
    {
    ...
    public:
         ...
         */
        Enclosing_Method_Attribute ( boost::uint16_t index );

        /*!
         * \brief Default Destructor
         */
        virtual ~Enclosing_Method_Attribute(){}

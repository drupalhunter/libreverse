...
#ifndef JAVA_EXCEPTIONS_ATTRIBUTE_H_
#define JAVA_EXCEPTIONS_ATTRIBUTE_H_
...
namespace reverse { namespace java_module {
    ...
    class Exceptions_Attribute
        : public Attribute_Info,
          public boost::enable_shared_from_this<Exceptions_Attribute>
    {
    ...
    public:
         ...
         */
        Exceptions_Attribute ( boost::uint16_t index );
    ...
    private:
        ...
        boost::uint16_t m_number_of_exceptions;

        std::vector<boost::uint16_t> m_exceptions_index_table;

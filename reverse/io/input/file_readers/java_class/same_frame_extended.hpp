...
#ifndef JAVA_SAME_FRAME_EXTENDED_H_
#define JAVA_SAME_FRAME_EXTENDED_H_
...
namespace libreverse { namespace java_module {
    ...
    class Same_Frame_Extended : public Stack_Map_Frame,
                                public boost::enable_shared_from_this<Same_Frame_Extended>
      {
      public:
         ...
         */
        Same_Frame_Extended ( boost::uint8_t tag );

        /*!
         * \brief Default Destructor
         */
        virtual ~Same_Frame_Extended(){}
...
#endif /* JAVA_SAME_FRAME_EXTENDED_H_ */

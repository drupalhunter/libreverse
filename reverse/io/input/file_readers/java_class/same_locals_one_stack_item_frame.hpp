/*  Same_Locals_One_Stack_Item_Frame.h
...
#ifndef JAVA_SAME_LOCALS_STACK_ITEM_FRAME_H_
#define JAVA_SAME_LOCALS_STACK_ITEM_FRAME_H_
...
namespace reverse { namespace java_module {
     ...
     */
    class Same_Locals_One_Stack_Item_Frame : public Stack_Map_Frame,
                                             public boost::enable_shared_from_this<Same_Locals_One_Stack_Item_Frame>
    {
    ...
    public:
         ...
         */
        Same_Locals_One_Stack_Item_Frame ( boost::uint8_t tag );

        /*!
         * \brief Default Destructor
         */
        virtual ~Same_Locals_One_Stack_Item_Frame(){}
...
#endif /* JAVA_SAME_LOCALS_ONE_STACK_ITEM_FRAME_H_ */

...
#ifndef JAVA_SYNTHETIC_ATTRIBUTE_H_
#define JAVA_SYNTHETIC_ATTRIBUTE_H_
...
namespace reverse { namespace java_module {
    ...
    class Synthetic_Attribute : public Attribute_Info,
                                public boost::enable_shared_from_this<Synthetic_Attribute>
    {
    ...
    public:
         ...
         */
        Synthetic_Attribute ( boost::uint16_t index );
...
#endif /* JAVA_SYNTHETIC_ATTRIBUTE_H_ */

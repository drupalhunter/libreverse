...
#ifndef JAVA_LINE_NUMBER_TABLE_ATTRIBUTE_H_
#define JAVA_LINE_NUMBER_TABLE_ATTRIBUTE_H_
...
namespace libreverse { namespace java_module {
    ...
    class Line_Number_Table_Attribute
        : public Attribute_Info,
          public boost::enable_shared_from_this<Line_Number_Table_Attribute>
    {
    public:
         ...
         */
        Line_Number_Table_Attribute ( boost::uint16_t index );

        /*!
         * \brief Default Destructor
         */
        virtual ~Line_Number_Table_Attribute(){}
    ...
    private:
        ...
        boost::uint16_t m_line_number_table_length;

        typedef std::vector< java_types::Line_Number_Item::ptr_t > List_t;
        List_t m_line_number_table;
  };

...
#ifndef JAVA_CONSTANT_STRING_INFO_H_
#define JAVA_CONSTANT_STRING_INFO_H_

#include "Constant_Pool_Info.h"
#include <boost/enable_shared_from_this.hpp>

/* Comments for the variables in the string are taken from
...
namespace libreverse { namespace java_module {
    ...
    class Constant_String_Info
        : public Constant_Pool_Info,
          public boost::enable_shared_from_this<Constant_String_Info>
    {
    public:
        ...
        boost::uint16_t get_String_Index (void) const;
    ...
    private:
        ...
        /*
         * !\brief The value of the string_index item must be a valid
...
#endif /* JAVA_CONSTANT_STRING_INFO_H_ */

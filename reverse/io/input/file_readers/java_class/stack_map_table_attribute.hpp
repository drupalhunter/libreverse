...
#ifndef JAVA_STACK_MAP_TABLE_ATTRIBUTE_H_
#define JAVA_STACK_MAP_TABLE_ATTRIBUTE_H_
...
namespace reverse { namespace java_module {
    ...
    class Stack_Map_Table_Attribute
        : public Attribute_Info,
          public boost::enable_shared_from_this<Stack_Map_Table_Attribute>
    {
    public:

        typedef boost::shared_ptr<Stack_Map_Table_Attribute> ptr_t;
         ...
         */
        Stack_Map_Table_Attribute ( boost::uint16_t index );

        /*!
         * \brief Default Destructor
         */
        virtual ~Stack_Map_Table_Attribute(){}
    ...
    private:
        ...
        boost::uint16_t m_number_of_entries;

        typedef std::vector< boost::shared_ptr<Stack_Map_Frame> > List_t;
        List_t m_entries;
    };

/*  Constant_InterfaceMethodref_Info.h
...
#ifndef JAVA_CONSTANT_INTERFACEMETHODREF_INFO_H_
#define JAVA_CONSTANT_INTERFACEMETHODREF_INFO_H_
...
namespace reverse { namespace java_module {
    ...
    class Constant_InterfaceMethodref_Info
        : public Constant_Pool_Info,
          public boost::enable_shared_from_this<Constant_InterfaceMethodref_Info>
    {
    public:
    ...
    private:
         ...
         * declaration of the interfaceMethod or method.
         */
         ...
         * This must be a interfaceMethod descriptor.
         */
...
#endif /* JAVA_CONSTANT_INTERFACEMETHODREF_INFO_H_ */

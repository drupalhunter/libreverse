...
#ifndef JAVA_DEPRECATED_ATTRIBUTE_H_
#define JAVA_DEPRECATED_ATTRIBUTE_H_
...
namespace libreverse { namespace java_module {
    ...
    class Deprecated_Attribute
        : public Attribute_Info,
          public boost::enable_shared_from_this<Deprecated_Attribute>
    {
    public:
         ...
         */
        Deprecated_Attribute ( boost::uint16_t index );

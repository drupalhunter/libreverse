...
#ifndef ELF_READER_32_H
#define ELF_READER_32_H
...
namespace libreverse
{
  namespace elf_module
  {
	 ...
	 */
	Elf_Reader_32 ( io_types::File_ID::const_ptr_t target_file );
	...
	elf_types::Elf_Header_32::ptr_t get_Header ( void );
	 ...
	 */
	void read_Relocation_Headers ( elf_types::Elf_Section_Header_32::const_ptr_t sec_hdr,
				       elf_types::Elf_File_Header_32::const_ptr_t file_hdr );

	/*!
	 * \brief Get the Relocation Addend headers (SHT_RELA)
	 */
	void read_Relocation_Addend_Headers ( elf_types::Elf_Section_Header_32::const_ptr_t sec_hdr,
					      elf_types::Elf_File_Header_32::const_ptr_t file_hdr );

	/*!
	 * \brief Get the Relocation symbols
	 */
	void read_Relocation_Symbols ( elf_types::Elf_Section_Header_32::const_ptr_t sec_hdr,
				       elf_types::Elf_File_Header_32::const_ptr_t file_hdr );
	...
	void set_Symbol_Name ( elf_types::Elf_Symbol_32::ptr_t symbol_ptr );

	elf_types::Elf_File::const_ptr_t get_File (void) const;
	...
	elf_types::Elf_Header_32::ptr_t m_elf_data;

...
namespace libreverse { namespace elf_module {
    ...
    Elf_Header_32::Elf_Header_32 ()
        : m_base_address_set ( false ),
          m_base_memory_address ( 0 ),
	  m_image_size ( 0 ),
	  m_highest_memory_address ( 0 ),
	  m_highest_memory_size ( 0 ),
          m_dyn_hdr ( new Elf_Dynamic_Header_32() )
    {
    ...
    Elf_Header_32::convert ()
    {
        ...
        for ( elf_types::Elf_Header_32::Program_Header_List_t::iterator pos_ptr = m_prg_hdrs.begin();
              pos_ptr != m_prg_hdrs.end();
              ++pos_ptr )
            {
	      elf_types::Elf_Program_Header_32::ptr_t obj =
		boost::const_pointer_cast<elf_module::Elf_Program_Header_32>( (*pos_ptr) );
	      obj->convert();
            }

        for ( elf_types::Elf_Header_32::Section_Header_Map_t::iterator pos_ptr = m_sec_hdrs.begin();
              pos_ptr != m_sec_hdrs.end();
              ++pos_ptr )
            {
                elf_types::Elf_Section_Header_32::ptr_t sec_ptr = 
		  boost::const_pointer_cast<elf_module::Elf_Section_Header_32>( (*pos_ptr).second );
                sec_ptr->convert ();
            }
    ...
    Elf_Header_32::to_String ()
    {
        ...
        for ( elf_types::Elf_Header_32::Section_Header_Map_t::const_iterator pos_ptr
                  = m_sec_hdrs.begin();
              pos_ptr != m_sec_hdrs.end();
              ++pos_ptr )
            {
	      elf_types::Elf_Section_Header_32::const_ptr_t sec_ptr = (*pos_ptr).second;
    ...
    void
    Elf_Header_32::get_Text_String ( io_types::Text_Data::data_type* output ) const
    {
        ...
        for ( elf_types::Elf_Header_32::Section_Header_Map_t::const_iterator pos_ptr = m_sec_hdrs.begin();
              pos_ptr != m_sec_hdrs.end();
              ++pos_ptr )
            {
                elf_types::Elf_Section_Header_32::const_ptr_t sec_ptr = (*pos_ptr).second;
    ...
    elf_types::Elf_File_Header_32::const_ptr_t
    Elf_Header_32::get_File_Header (void) const
    {
    ...
    bool
    Elf_Header_32::is_File_Header_Set (void) const
    {
    ...
    void Elf_Header_32::set_File_Header ( elf_types::Elf_File_Header_32::ptr_t hdr )
    {
    ...
    elf_types::Elf_Section_Header_32::const_ptr_t
    Elf_Header_32::get_Section_Header ( boost::uint16_t index ) const
    {
    ...
    elf_types::Elf_Section_Header_32::const_ptr_t
    Elf_Header_32::get_Section_Header ( std::string name ) const
    {
        ...
        elf_types::Elf_Header_32::Section_Header_Map_t::const_iterator pos = m_sec_hdrs.find ( name );
    ...
    elf_types::Elf_Header_32::Section_Header_Map_t::const_iterator
    Elf_Header_32::get_Section_Header_Begin (void) const
    {
        return m_sec_hdrs.begin();
    }

    elf_types::Elf_Header_32::Section_Header_Map_t::const_iterator
    Elf_Header_32::get_Section_Header_End (void) const
    {
        return m_sec_hdrs.end();
    }

    void
    Elf_Header_32::push_Back_Section_Header ( elf_types::Elf_Section_Header_32::const_ptr_t sec_ptr )
    {
    ...
    void
    Elf_Header_32::push_Back_Program_Header ( elf_types::Elf_Program_Header_32::const_ptr_t prg )
    {
        ...
        if ( ! m_base_address_set )
            {
                ...
                m_base_memory_address = prg->get_Virtual_Address();

		if ( prg->get_Type() == Elf_Common::PT_LOAD )
		  {
		    m_highest_memory_size = prg->get_Virtual_Address();
		    m_highest_memory_size = prg->get_Memory_Size();
		  }
            }
        else if ( ( prg->get_Virtual_Address() < m_base_memory_address ) && ( prg->get_Virtual_Address() != 0 ) )
            {
                m_base_memory_address = prg->get_Virtual_Address();
            }
        else if ( ( prg->get_Virtual_Address() > m_highest_memory_address ) &&
		  ( prg->get_Virtual_Address() != 0 ) &&
		  ( prg->get_Type() == Elf_Common::PT_LOAD ) )
            {
                m_highest_memory_address = prg->get_Virtual_Address();
		m_highest_memory_size = prg->get_Memory_Size();
            }
        else
            {
    ...
    void
    Elf_Header_32::push_Back_Relocation_Header ( elf_types::Elf_Relocation_32::const_ptr_t rel )
    {
    ...
    void
    Elf_Header_32::push_Back_Relocation_Add_Header ( elf_types::Elf_Relocation_Add_32::const_ptr_t rel )
    {
    ...
    bool Elf_Header_32::has_Section_Headers (void)
    {
    ...
    bool Elf_Header_32::has_Program_Headers (void)
    {
    ...
    bool Elf_Header_32::has_Symbols (void)
    {
    ...
    std::string
    Elf_Header_32::get_Program_Header_String (void) const
    {
        ...
        for ( elf_types::Elf_Header_32::Program_Header_List_t::const_iterator pos = m_prg_hdrs.begin();
              pos != m_prg_hdrs.end();
              ++pos )
            {
    ...
    std::string
    Elf_Header_32::get_Symbol_Token_String ( char const* string_table ) const
    {
        ...
        for ( elf_types::Elf_Header_32::Symbol_List_t::const_iterator pos =  m_symbol_table.begin();
			...
			elf_types::Elf_Symbol_32::ptr_t obj =
			  boost::const_pointer_cast<elf_module::Elf_Symbol_32>( (*pos) );
    ...
    std::string
    Elf_Header_32::get_Relocation_String (void) const
    {
        ...
        for ( elf_types::Elf_Header_32::Relocation_List_t::const_iterator pos = m_relocs.begin();
              pos != m_relocs.end();
              ++pos )
            {
                output << (*pos)->to_String() << std::endl;
    ...
    std::string
    Elf_Header_32::get_Relocation_Add_String (void) const
    {
        ...
        for ( elf_types::Elf_Header_32::Relocation_Add_List_t::const_iterator pos = m_relocs_add.begin();
    ...
    void
    Elf_Header_32::push_Back_Symbol ( elf_types::Elf_Symbol_32::const_ptr_t sym )
    {
    ...
    elf_types::Elf_Symbol_32::const_ptr_t
    Elf_Header_32::get_Symbol ( boost::uint32_t index )
    {
    ...
    elf_types::Elf_Program_Header_32::const_ptr_t
      Elf_Header_32::get_Program_Header ( boost::uint32_t addr ) const
    {
        ...
        elf_types::Elf_Header_32::Program_Header_List_t::const_iterator pos;
    ...
    boost::uint32_t
    Elf_Header_32::get_Base_Address (void) const
    {
    ...
    boost::uint32_t
    Elf_Header_32::get_Loaded_Memory_Size (void) const
    {

#ifdef LIBREVERSE_DEBUG
        Trace::write_Trace ( TraceArea::IO,
                             TraceLevel::DETAIL,
                             "Inside Elf_Header::get_Loaded_Memory_Size" );
#endif /* LIBREVERSE_DEBUG */


	boost::uint32_t size = ( m_highest_memory_address + m_highest_memory_size ) - m_base_memory_address;
	return size;
    }

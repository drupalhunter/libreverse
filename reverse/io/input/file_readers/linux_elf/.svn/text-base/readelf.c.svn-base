     ...
     int pointer_size;
{
  ...
  switch (op_code)
    ...
    case DW_LNE_define_file:
      printf (_("  define new File Token entry\n"));
      ...
      while (data < end_of_sequence)
	{
	  ...
	  if (op_code >= info.li_opcode_base)
	    ...
	    case DW_LNS_set_file:
	      ...
	      data += bytes_read;
	      printf (_("  Set File Name to entry %d in the File Name Token\n"),
		      adv);

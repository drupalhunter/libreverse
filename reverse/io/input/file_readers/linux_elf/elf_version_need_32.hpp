...
#ifndef REVERSE_IO_INPUT_FILE_READERS_LINUX_ELF_ELF_VERSION_NEED_32_HPP_INCLUDED
#define REVERSE_IO_INPUT_FILE_READERS_LINUX_ELF_ELF_VERSION_NEED_32_HPP_INCLUDED
...
BOOST_FUSION_ADAPT_STRUCT (
			   struct reverse::io::input::file_readers::linux_elf::elf_version_need_32,
			   ( Elf32_Half, vn_version )
			   ( Elf32_Half, vn_cnt )
			   ( Elf32_Word, vn_file )
			   ( Elf32_Word, vn_aux )

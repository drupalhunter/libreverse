...
namespace libreverse
{
  namespace elf_module
  {
    ...
    Elf_Relocation_32::Elf_Relocation_32 ( elf_types::Elf_File_Header_32::const_ptr_t file_hdr )
      : r_offset ( 0 ),
	r_info ( 0 ),
	...
	m_file_hdr ( file_hdr )
    {
      ...
      Trace::write_Trace ( TraceArea::IO,
			   TraceLevel::DETAIL,
			   "Inside Elf_Relocation_32 constructor" );
#endif /* LIBREVERSE_DEBUG */

    }

    void
    Elf_Relocation_32::convert ()
    {

#ifdef LIBREVERSE_DEBUG
      Trace::write_Trace ( TraceArea::IO,
			   TraceLevel::DETAIL,
			   "Entering Elf_Relocation_32::convert" );
#endif /* LIBREVERSE_DEBUG */
      ...
      Trace::write_Trace ( TraceArea::IO,
			   TraceLevel::DETAIL,
			   "Exiting Elf_Relocation_32::convert" );
#endif /* LIBREVERSE_DEBUG */
    ...
    std::string
    Elf_Relocation_32::to_String() const
    {

#ifdef LIBREVERSE_DEBUG
      Trace::write_Trace ( TraceArea::IO,
			   TraceLevel::DETAIL,
			   "Entering Elf_Relocation_32::to_String" );
#endif /* LIBREVERSE_DEBUG */
	...
	boost::io::group ( std::setfill ( '0' ), std::hex, std::setw ( 8 ), r_info );
      ...
      Trace::write_Trace ( TraceArea::IO,
			   TraceLevel::DETAIL,
			   "Exiting Elf_Relocation_32::to_String" );
#endif /* LIBREVERSE_DEBUG */
    ...
    boost::uint32_t
    Elf_Relocation_32::get_Symbol_Token_Index ( void )
    {

#ifdef LIBREVERSE_DEBUG
      Trace::write_Trace ( TraceArea::IO,
			   TraceLevel::DETAIL,
			   "Inside Elf_Relocation_32::get_Symbol_Token_Index" );
#endif /* LIBREVERSE_DEBUG */

...
#ifndef ELF_FILE_HEADER_32_H
#define ELF_FILE_HEADER_32_H
#include <string>
...
namespace libreverse { namespace elf_module {
    ...
    class Elf_File_Header_32 : public libreverse::header::Base_Header {
    public:
         ...
         */
        virtual void get_Text_String ( io_types::Text_Data::data_type* output ) const;
	...
	std::string get_File_Type_Meta () const;
        ...
        boost::uint32_t get_Program_Header_Offset(void) const;

        boost::uint16_t get_Section_Header_Count (void) const;

        boost::uint32_t get_Section_Header_Offset(void) const;
	...
	elf_types::Elf_Header_Eident::ptr_t get_Eident (void) const;
        ...
        boost::uint32_t get_Entry (void) const;

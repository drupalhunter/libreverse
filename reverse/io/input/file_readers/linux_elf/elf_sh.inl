...
namespace libreverse { namespace elf_module {
    ...
    Elf_sh::get_Type (boost::uint32_t type)
    {
        ...
        switch (type)
		  ...
		  Trace::write_Trace ( TraceArea::IO,
				       TraceLevel::ERROR,
				       boost::str ( boost::format ( "Unknown sh relocation type: %1%" ) % type ) );
#endif /* LIBREVERSE_DEBUG */
    ...
    Elf_sh::EF_SH_MERGE_MACH (boost::uint8_t mach1, boost::uint8_t mach2)
    {
        ...
        Trace::write_Trace ( TraceArea::IO,
                             TraceLevel::DETAIL,
                             "Entering Elf_sh::EF_SH_MERGE_MACH" );
#endif /* LIBREVERSE_DEBUG */
        ...
        Trace::write_Trace ( TraceArea::IO,
                             TraceLevel::DETAIL,
                             "Exiting Elf_sh::EF_SH_MERGE_MACH" );
#endif /* LIBREVERSE_DEBUG */

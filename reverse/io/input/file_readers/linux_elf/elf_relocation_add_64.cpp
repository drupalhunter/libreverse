...
namespace libreverse
{
  namespace elf_module
  {
    ...
    Elf_Relocation_Add_64::Elf_Relocation_Add_64 ( elf_types::Elf_File_Header_64::const_ptr_t file_hdr )
      : r_offset ( 0 ),
	r_info ( 0 ),
	r_addend ( 0 ),
	...
	m_file_hdr ( file_hdr )
    {
      ...
      Trace::write_Trace ( TraceArea::IO,
			   TraceLevel::DETAIL,
			   "Inside Elf_Relocation_Add_64 constructor" );
#endif /* LIBREVERSE_DEBUG */

    }

    void Elf_Relocation_Add_64::convert ()
    {

#ifdef LIBREVERSE_DEBUG
      Trace::write_Trace ( TraceArea::IO,
			   TraceLevel::DETAIL,
			   "Entering Elf_Relocation_Add_64::convert" );
#endif /* LIBREVERSE_DEBUG */
      ...
      Trace::write_Trace ( TraceArea::IO,
			   TraceLevel::DETAIL,
			   "Exiting Elf_Relocation_Add_64::convert" );
#endif /* LIBREVERSE_DEBUG */

    }

    std::string
    Elf_Relocation_Add_64::to_String() const
    {

#ifdef LIBREVERSE_DEBUG
      Trace::write_Trace ( TraceArea::IO,
			   TraceLevel::DETAIL,
			   "Entering Elf_Relocation_Add_64::to_String" );
#endif /* LIBREVERSE_DEBUG */
	...
	boost::io::group ( std::setfill ( '0' ), std::hex, std::setw ( 16 ), r_info );
      ...
      output << boost::format ( "0x%1% " ) %
	boost::io::group ( std::setfill ( '0' ), std::hex, std::setw ( 16 ), r_addend );
      ...
      Trace::write_Trace ( TraceArea::IO,
			   TraceLevel::DETAIL,
			   "Exiting Elf_Relocation_Add_64::to_String" );
#endif /* LIBREVERSE_DEBUG */
    ...
    boost::uint64_t
    Elf_Relocation_Add_64::get_Symbol_Token_Index ( void ) const
    {

#ifdef LIBREVERSE_DEBUG
      Trace::write_Trace ( TraceArea::IO,
			   TraceLevel::DETAIL,
			   "Inside Elf_Relocation_Add_64::get_Symbol_Token_Index" );
#endif /* LIBREVERSE_DEBUG */

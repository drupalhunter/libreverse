...
#ifndef REVERSE_IO_INPUT_FILE_READERS_LINUX_ELF_ELF_MIPS_HPP_INCLUDED
#define REVERSE_IO_INPUT_FILE_READERS_LINUX_ELF_ELF_MIPS_HPP_INCLUDED
	...
	namespace linux_elf {
	  ...
	  public:
	    ...
	    */
	    ...
	    static inline boost::uint32_t elf64_mips_r_ssym (boost::uint64_t input);

	    static inline boost::uint32_t elf64_mips_r_type3 (boost::uint64_t input);

	    static inline boost::uint32_t elf64_mips_r_type2 (boost::uint64_t input);

	    static inline boost::uint32_t elf64_mips_r_type (boost::uint64_t input);
...
#endif // ifndef REVERSE_IO_INPUT_FILE_READERS_LINUX_ELF_ELF_MIPS_HPP_INCLUDED

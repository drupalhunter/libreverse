...
#ifndef ELF_RELOCATION_32_H
#define ELF_RELOCATION_32_H
...
namespace libreverse { namespace elf_module {
     ...
     */
    class Elf_Relocation_32 : public header::Base_Header {

        friend class Elf_File;

    public:

        Elf_Relocation_32 ( elf_types::Elf_File_Header_32::const_ptr_t file_hdr );

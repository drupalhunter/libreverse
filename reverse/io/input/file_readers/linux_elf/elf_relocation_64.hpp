...
#ifndef REVERSE_IO_INPUT_FILE_READERS_LINUX_ELF_ELF_RELOCATION_64_HPP_INCLUDED
#define REVERSE_IO_INPUT_FILE_READERS_LINUX_ELF_ELF_RELOCATION_64_HPP_INCLUDED
	...
	namespace linux_elf {
	  ...
	  struct elf_relocation_64 {
	    ...
	    /*
	      ...
	      little-endian value: it has a 64-bit little-endian symbol index
	      ...
	      applying ELF64_R_TYPE or ELF64_R_SYM, respectively, to the entry
	      s r_info member.
	    */
	    Elf64_Word r_info;
	  };
...
BOOST_FUSION_ADAPT_STRUCT (
			   reverse::io::input::file_readers::linux_elf::elf_relocation_64,
			   (Elf64_Addr, r_offset)
			   (Elf64_Word, r_info)
)

#endif // ifndef REVERSE_IO_INPUT_FILE_READERS_LINUX_ELF_ELF_RELOCATION_64_HPP_INCLUDED

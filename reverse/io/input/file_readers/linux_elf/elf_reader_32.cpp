...
namespace libreverse
{
    namespace elf_module
    {
        ...
        Elf_Reader_32::Elf_Reader_32 ( io_types::File_ID::const_ptr_t target_file )
	  : m_elf_file ( new Elf_File ( target_file ) ),
	    m_convert ( false ),
	    m_elf_data ( new Elf_Header_32() )
        {
      ...
      Elf_Reader_32::~Elf_Reader_32 ( void )
      {
	...
	Trace::write_Trace ( TraceArea::IO,
        ...
        void Elf_Reader_32::read_File_Header ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::read_File_Header" );
#endif /* LIBREVERSE_DEBUG */
            ...
            {
	      elf_types::Elf_File_Header_32::ptr_t new_file_hdr ( new Elf_File_Header_32() );
		  ...
		  m_convert = true;
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::read_File_Header" );
#endif /* LIBREVERSE_DEBUG */

        }

        void Elf_Reader_32::read_Section_Headers ()
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::read_Section_Headers" );
#endif /* LIBREVERSE_DEBUG */


            read_File_Header();

            std::vector< elf_types::Elf_Section_Header_32::ptr_t > m_section_list;

            // Move read point to position of section header table offset
	    elf_types::Elf_File_Header_32::const_ptr_t file_hdr_ref = m_elf_data->get_File_Header();

            if ( ( file_hdr_ref->get_Section_Header_Count() > 0 ) &&
                    ( ! m_elf_data->has_Section_Headers() ) )
            {
                // Start by moving to the section header offset
	      boost::uint32_t sec_offset = file_hdr_ref->get_Section_Header_Offset();
	      ...
	      m_elf_file->seek ( sec_offset );
                ...
                for ( boost::uint32_t i = 0;
                        ...
                        i++ )
                {
		  elf_types::Elf_Section_Header_32::ptr_t temp ( new Elf_Section_Header_32 ( file_hdr_ref->get_Machine_Value() ) );
		  ...
		  m_elf_file->read_Elf_Section_Header ( temp );
                ...
                {
		  elf_types::Elf_Section_Header_32::ptr_t string_hdr = m_section_list[ string_token_index ];
                    ...
                    // TODO error handling
                    m_string_table_ptr = m_elf_file->subset ( string_hdr->get_Section_Size() );

                    for ( std::vector<elf_types::Elf_Section_Header_32::ptr_t >::iterator pos = m_section_list.begin();
			  pos != m_section_list.end();
			  pos++ )
                    {

		      elf_types::Elf_Section_Header_32::ptr_t sec_hdr_ptr = ( *pos );
			  ...
			  Trace::write_Trace ( TraceArea::IO,
                        ...
                        {
                            sec_hdr_ptr->set_Section_String_Name ( this->get_String_Name ( sec_hdr_ptr->get_Section_Name_Index() ) );
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::read_Section_Headers" );
#endif /* LIBREVERSE_DEBUG */

        }

        void Elf_Reader_32::read_Program_Headers ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::read_Program_Headers" );
#endif /* LIBREVERSE_DEBUG */
	    ...
	    elf_types::Elf_File_Header_32::const_ptr_t file_hdr_ref = m_elf_data->get_File_Header();
                    ...
                    ( ! m_elf_data->has_Program_Headers() ) )
            {
                ...
                for ( unsigned int i = 0;
                        ...
                        ++i )
                {
		  elf_types::Elf_Program_Header_32::ptr_t prg_hdr ( new Elf_Program_Header_32 ( file_hdr_ref->get_Machine_Value() ) );
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::read_Program_Headers" );
#endif /* LIBREVERSE_DEBUG */

        }

        void Elf_Reader_32::read_Dynamic_Headers ( void )
        {
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::read_Dynamic_Headers" );
#endif /* LIBREVERSE_DEBUG */


            //Elf_Dynamic_Header_32 *dyn_hdr = new Elf_Dynamic_Header_32();
            ...
            */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::read_Dynamic_Headers" );
#endif /* LIBREVERSE_DEBUG */

        }

      std::string
      Elf_Reader_32::get_File_Type ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::get_File_Type" );
#endif /* LIBREVERSE_DEBUG */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::get_File_Type" );
#endif /* LIBREVERSE_DEBUG */
        ...
        std::string
        Elf_Reader_32::get_Arch_Type ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::get_Arch_Type" );
#endif /* LIBREVERSE_DEBUG */


            read_File_Header();

	    elf_types::Elf_File_Header_32::const_ptr_t file_hdr_ptr = m_elf_data->get_File_Header();
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::get_Arch_Type" );
#endif /* LIBREVERSE_DEBUG */
        ...
        std::string
        Elf_Reader_32::get_Section_Offset ( std::string name )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::get_Section_Offset" );
#endif /* LIBREVERSE_DEBUG */
	    ...
	    elf_types::Elf_Section_Header_32::const_ptr_t sec_hdr_ptr =
	      m_elf_data->get_Section_Header ( this->get_Section_String ( name ) );
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::get_Section_Offset" );
#endif /* LIBREVERSE_DEBUG */
        ...
        std::string
        Elf_Reader_32::get_Section_Length ( std::string name )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::get_Section_Length" );
#endif /* LIBREVERSE_DEBUG */
	    ...
	    elf_types::Elf_Section_Header_32::const_ptr_t sec_hdr_ptr =
	      m_elf_data->get_Section_Header ( this->get_Section_String ( name ) );
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::get_Section_Length" );
#endif /* LIBREVERSE_DEBUG */
        ...
        std::string
        Elf_Reader_32::get_Entry_Point ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::get_Entry_Point" );
#endif /* LIBREVERSE_DEBUG */
	    ...
	    elf_types::Elf_File_Header_32::const_ptr_t file_hdr_ptr = m_elf_data->get_File_Header();
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::get_Entry_Point" );
#endif /* LIBREVERSE_DEBUG */
        ...
        std::string
        Elf_Reader_32::get_Base_Address ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::get_Base_Address" );
#endif /* LIBREVERSE_DEBUG */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::get_Base_Address" );
#endif /* LIBREVERSE_DEBUG */
        ...
        void
	Elf_Reader_32::read_Symbol_Token ()
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::read_Symbol_Token" );
#endif /* LIBREVERSE_DEBUG */


            /*
              Elf_File_Header_32::ptr_t file_hdr =
              m_elf_data->get_File_Header();

              Elf_Section_Header_32::ptr_t sec_hdr;
              ...
              Elf_Section_Header_32::ptr_t symbol_hdr = sec_hdr;

              Elf_Section_Header_32::ptr_t symbol_string_hdr =
              ...
              {
              Elf_Symbol_32::ptr_t symbol
              (new Elf_Symbol_32 (file_hdr->get_Machine_Value()));
            ...
            */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::read_Symbol_Token" );
#endif /* LIBREVERSE_DEBUG */

        }

        void
	Elf_Reader_32::read_Relocations ()
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::read_Relocations" );
#endif /* LIBREVERSE_DEBUG */
		...
		elf_types::Elf_Section_Header_32::const_ptr_t sec_hdr_ptr;
		      ...
		      ++pos )
		  {
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::read_Relocations" );
#endif /* LIBREVERSE_DEBUG */
        ...
        bool
	Elf_Reader_32::support_File_Type ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::support_File_Type" );
#endif /* LIBREVERSE_DEBUG */
            ...
            else
            {
                ...
                Trace::write_Trace ( TraceArea::IO,
                                     TraceLevel::DETAIL,
                                     "Exiting Elf_Reader_32::support_File_Type" );
#endif /* LIBREVERSE_DEBUG */
        ...
        void
	Elf_Reader_32::read_Relocation_Headers ( elf_types::Elf_Section_Header_32::const_ptr_t sec_hdr,
						 elf_types::Elf_File_Header_32::const_ptr_t file_hdr )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::read_Relocation_Headers" );
#endif /* LIBREVERSE_DEBUG */
            ...
            {
	      elf_types::Elf_Relocation_32::ptr_t reloc_hdr_ptr ( new Elf_Relocation_32 ( file_hdr ) );
	      ...
	      elf_types::Elf_Symbol_32::const_ptr_t reloc_symbol_ptr =
		m_elf_data->get_Symbol ( reloc_hdr_ptr->get_Symbol_Token_Index() );
	      ...
	      Trace::write_Trace ( TraceArea::IO,
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::read_Relocation_Headers" );
#endif /* LIBREVERSE_DEBUG */

        }

        void
	Elf_Reader_32::read_Relocation_Addend_Headers ( elf_types::Elf_Section_Header_32::const_ptr_t sec_hdr,
							elf_types::Elf_File_Header_32::const_ptr_t file_hdr )
        {
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::read_Relocation_Addend_Headers" );
#endif /* LIBREVERSE_DEBUG */
            ...
            for ( boost::uint32_t i = 0; i < number_relocs; ++i )
            {
	      elf_types::Elf_Relocation_Add_32::ptr_t reloc_add_hdr_ptr ( new Elf_Relocation_Add_32 ( file_hdr ) );
		...
		Trace::write_Trace ( TraceArea::IO,
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::read_Relocation_Addend_Headers" );
#endif /* LIBREVERSE_DEBUG */
        ...
        void
	Elf_Reader_32::read_Relocation_Symbols ( elf_types::Elf_Section_Header_32::const_ptr_t sec_hdr,
						 elf_types::Elf_File_Header_32::const_ptr_t file_hdr )
        {
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::read_Relocation_Symbols" );
#endif /* LIBREVERSE_DEBUG */


            // Setup file for position to reading Relocation Symbols
            elf_types::Elf_Section_Header_32::const_ptr_t sym_hdr =
                m_elf_data->get_Section_Header ( sec_hdr->get_Next_Section_Index() );

            elf_types::Elf_Section_Header_32::const_ptr_t sym_string_hdr =
            ...
            {
                elf_types::Elf_Symbol_32::ptr_t reloc_symbol ( new Elf_Symbol_32 ( file_hdr->get_Machine_Value() ) );
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::read_Relocation_Symbols" );
#endif /* LIBREVERSE_DEBUG */
        ...
        void
        Elf_Reader_32::read_Headers ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::read_Headers" );
#endif /* LIBREVERSE_DEBUG */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::read_Headers" );
#endif /* LIBREVERSE_DEBUG */

        }

        data_types::Memory_Map::ptr_t
        Elf_Reader_32::get_Memory_Map ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::get_Memory_Map" );
#endif /* LIBREVERSE_DEBUG */
	    ...
	    boost::uint32_t base_address = m_elf_data->get_Base_Address();

	    boost::uint32_t memory_size = m_elf_data->get_Loaded_Memory_Size();

	    Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DATA,
				 boost::str ( boost::format ( "Elf_Reader_32::get_Memory_Map - base_address = 0x%1$-08X (0x%2$-08X)" )
					      % base_address
					      % memory_size ) );
            ...
            */
	    elf_types::Elf_File_Header_32::const_ptr_t elf_file_hdr_ptr = m_elf_data->get_File_Header();
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::get_Memory_Map" );
#endif /* LIBREVERSE_DEBUG */
        ...
        Elf_Reader_32::get_Section_String ( std::string name ) const
        {
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::get_Section_String" );
#endif /* LIBREVERSE_DEBUG */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::get_Section_String" );
#endif /* LIBREVERSE_DEBUG */
        ...
        std::string
        Elf_Reader_32::to_String ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::to_String" );
#endif /* LIBREVERSE_DEBUG */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::to_String" );
#endif /* LIBREVERSE_DEBUG */
        ...
        Elf_Reader_32::get_Text_Strings ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::get_Text_String" );
#endif /* LIBREVERSE_DEBUG */
        ...
        io_types::Text_Data::data_type
        Elf_Reader_32::get_UTF16_Strings ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::get_UTF16_String" );
#endif /* LIBREVERSE_DEBUG */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::get_UTF16_String" );
#endif /* LIBREVERSE_DEBUG */
        ...
        std::string
        Elf_Reader_32::get_String_Name ( boost::uint32_t index ) const
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::get_String_Name" );
#endif /* LIBREVERSE_DEBUG */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_Reader_32::get_String_Name" );
#endif /* LIBREVERSE_DEBUG */
        ...
        void
        Elf_Reader_32::set_Symbol_Name ( elf_types::Elf_Symbol_32::ptr_t symbol_ptr )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_Reader_32::set_Symbol_Name" );
#endif /* LIBREVERSE_DEBUG */
            ...
            if ( symbol_ptr->get_String_Token_Index() == 0 )
            {
                ...
                if ( symbol_ptr->get_Symbol_Type_Value() == Elf_Common::STT_SECTION )
                {
                    ...
                    {
                        // Grab section header
		      elf_types::Elf_Section_Header_32::const_ptr_t sec_hdr = m_elf_data->get_Section_Header ( sec_index );
        ...
        elf_types::Elf_Header_32::ptr_t
        Elf_Reader_32::get_Header ( void )
        {

#ifdef LIBREVERSE_DEBUG
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Inside Elf_Reader_32::get_Header" );
#endif /* LIBREVERSE_DEBUG */
      ...
      elf_types::Elf_File::const_ptr_t
      Elf_Reader_32::get_File (void) const
     {

...
namespace reverse {
  namespace io {
	...
	namespace linux_elf {
	  ...
	  {
	    trace::io_detail ( "inside elf_reader_32::support_file_type" );
	  ...
	  elf_reader_32::get_memory_map ( void )
	  {
	    ...
	    for ( std::vector < elf_program_header_32 >::const_iterator cpos = m_elf_file.program_headers.begin();
	    ...
	    */
	    ...
	    trace::io_detail ( "exiting elf_reader_32::get_memory_map" );
	  ...
	  Elf_Reader_32::get_Section_String ( std::string name ) const
	  {
	    ...
	    // \todo Figure out what this was doing
...
// #endif /* LIBREVERSE_DEBUG */
	  ...
	  {
	    trace::io_detail ( "entering elf_reader_32::to_string" );
...
// #endif /* LIBREVERSE_DEBUG */
	  ...
	  {
	    trace::io_detail ( "entering elf_reader_32::get_text_string" );

	    std::vector < std::string > output;

	    // \todo Grab ASCII text strings from file.
...
// #endif /* libreverse_debug */
	  ...
	  elf_reader_32::get_utf16_strings ( void )
	  {
	    ...
	    trace::io_detail ( "entering elf_reader_32::get_utf16_string" );
	    std::vector < std::string > output;

	    // For each section
	    //  - Read UTF-16 Strings

	    trace::io_detail ( "exiting elf_reader_32::get_utf16_string" );
	  ...
	  elf_reader_32::get_string_name ( boost::uint32_t index ) const
	  {
	    ...
	    trace::io_detail ( "exiting elf_reader_32::get_string_name" );

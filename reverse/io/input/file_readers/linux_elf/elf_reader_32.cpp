...
#include <reverse/io/input/file_readers/linux_elf/elf_file.hpp>
...
#include <reverse/io/input/file_readers/linux_elf/elf_symbol_32.hpp>
...
elf_reader_32::elf_reader_32 ( boost::shared_ptr < const io::file_id > target_file )
...
void elf_reader_32::read_headers ( void )
{
...
//           m_elf_data->set_file_header ( new_file_hdr );
	...
	throw errors::io_exception ( "Error parsing input file." );
     ...
     trace::io_detail ( "Exiting elf_reader_32::read_file_header" );
}
...
{
    trace::io_detail ( "Entering Elf_Reader_32::get_Arch_Type" );
    ...
    trace::io_detail("Exiting Elf_Reader_32::get_Arch_Type" );
...
elf_reader_32::get_file ( void ) const
{
    ...
    trace::io_detail( "inside elf_reader_32::get_header" );

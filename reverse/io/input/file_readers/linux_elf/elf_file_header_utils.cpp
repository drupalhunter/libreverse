      ...
      Elf_File_Header_Utils::get_File_Type_Name ( boost::uint16_t e_type )
        {
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_File_Header_Utils::get_File_Type_Name" );
#endif /* LIBREVERSE_DEBUG */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_File_Header_Utils::get_File_Type_Name" );
#endif /* LIBREVERSE_DEBUG */
        ...
        Elf_File_Header_Utils::get_File_Type_Meta ( boost::uint16_t e_type )
        {
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_File_Header_Utils::get_File_Type_Meta" );
#endif /* LIBREVERSE_DEBUG */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_File_Header_Utils::get_File_Type_Meta" );
#endif /* LIBREVERSE_DEBUG */
        ...
        Elf_File_Header_Utils::get_Arch_Name ( boost::uint16_t e_machine )
        {
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_File_Header_Utils::get_Arch_Name" );
#endif /* LIBREVERSE_DEBUG */
	    ...
	    case Elf_Common::EM_386:
	      {
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::ERROR,
				 boost::str ( boost::format ( "The architecture for the file was %1%" ) %
					      Elf_File_Header_Utils::get_Machine_Name ( e_machine ) ) );
#endif /* LIBREVERSE_DEBUG */

                    throw errors::File_Reader_Exception
		      ( errors::File_Reader_Exception::UNSUPPORTED_ARCH_TYPE );
                }
            }
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_File_Header_Utils::get_Arch_Name" );
#endif /* LIBREVERSE_DEBUG */
	...
	Elf_File_Header_Utils::get_Machine_Name ( boost::uint16_t e_machine )
        {
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_File_Header_Utils::get_Machine_Name" );
#endif /* LIBREVERSE_DEBUG */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_File_Header_Utils::get_Machine_Name" );
#endif /* LIBREVERSE_DEBUG */
        ...
        Elf_File_Header_Utils::decode_ARM_Machine_Flags ( boost::uint32_t e_flags )
        {
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_File_Header_Utils::decode_ARM_Machine_Flags" );
#endif /* LIBREVERSE_DEBUG */
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_File_Header_Utils::decode_ARM_Machine_Flags" );
#endif /* LIBREVERSE_DEBUG */
						   ...
						   boost::uint16_t e_machine )
        {
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Entering Elf_File_Header_Utils::get_Machine_Flags" );
#endif /* LIBREVERSE_DEBUG */
		...
		case Elf_Common::EM_ARM:
            ...
            Trace::write_Trace ( TraceArea::IO,
                                 TraceLevel::DETAIL,
                                 "Exiting Elf_File_Header_Utils::get_Machine_Flags" );
#endif /* LIBREVERSE_DEBUG */

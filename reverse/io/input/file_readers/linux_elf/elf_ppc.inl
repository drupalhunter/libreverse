...
namespace reverse {
  namespace io {
	...
	namespace linux_elf {
	  ...
	  {
	    trace::io_detail ( "Entering Elf_ppc::get_Type" );
	    ...
	    switch (type) 
	      ...
	      default:
                {
		  trace::io_error ( "Unknown ppc relocation type: %1%", type );
		  output = "unknown";
                }
	      }

	    trace::io_detail ( "Exiting Elf_ppc::get_Type" );
	  ...
	  {
	    trace::io_detail ( "Inside Elf_ppc::is_PPC_TLS_Reloc" );

...
struct elf_header_32_grammar : boost::spirit::qi::grammar < Iterator, reverse::io::input::file_readers::linux_elf::elf_header_32() > {
     elf_header_32_grammar ()
          : elf_header_32_grammar::base_type ( elf_header_info ) {
     using boost::spirit::qi::dword;
     using boost::spirit::qi::word;

     elf_header_info = e_type
      > e_machine
      > e_version
      > e_entry
      > e_phoff
      ...
      BOOST_SPIRIT_DEBUG_NODE ( elf_header_info );
  ...
  boost::spirit::qi::rule < Iterator, elf_header_32() > elf_header_info;

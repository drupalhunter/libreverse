...
#ifndef ELF_PROGRAM_HEADER_32_H
#define ELF_PROGRAM_HEADER_32_H
...
namespace libreverse { namespace elf_module {
     ...
     */
    class Elf_Program_Header_32 : public header::Base_Header {
    ...
    public:
       ...
       */
      Elf_Program_Header_32 ( boost::uint16_t e_machine );
	...
	program header we return TRUE. Otherwise FALSE.
      */
      bool in_Range ( boost::uint32_t addr ) const;

      /*! \brief Get result of p_vaddr - p_offset */
      boost::uint32_t get_Address_Offset (void) const;

      boost::uint32_t get_Virtual_Address (void) const;

      boost::uint32_t get_Memory_Size (void) const;

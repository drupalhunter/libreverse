...
namespace libreverse { namespace elf_module {
    ...
    void
    Elf_Dynamic_Tag_32::convert ()
    {

#ifdef LIBREVERSE_DEBUG
        Trace::write_Trace ( TraceArea::IO,
                             TraceLevel::DETAIL,
                             "Entering Elf_Dynamic_Tag_32::convert" );
#endif /* LIBREVERSE_DEBUG */
        ...
        Trace::write_Trace ( TraceArea::IO,
                             TraceLevel::DETAIL,
                             "Exiting Elf_Dynamic_Tag_32::convert" );
#endif /* LIBREVERSE_DEBUG */

    }

    std::string
    Elf_Dynamic_Tag_32::to_String ()
    {

#ifdef LIBREVERSE_DEBUG
        Trace::write_Trace ( TraceArea::IO,
                             TraceLevel::DETAIL,
                             "Entering Elf_Dynamic_Tag_32::to_String" );
#endif /* LIBREVERSE_DEBUG */

...
#ifndef SUB_FRAMEWORK_COMMAND_H
#define SUB_FRAMEWORK_COMMAND_H
...
namespace libreverse { namespace mach_module {
  ...
  public:
    ...
    Sub_Framework_Command ( boost::uint32_t cmd, boost::uint32_t cmdsize );

    virtual ~Sub_Framework_Command(){}
  ...
  private:
    ...
    mach_types::LC_Str::ptr_t m_umbrella;

...
namespace reverse {
  namespace optimizer {
    ...
    std::string
    Windows_Compression_Dump_Algorithm::process ( boost::uint32_t compression_id,
					      std::string filename )
    {
      Trace::write_Trace ( TraceArea::GRNN_OPTIMIZER,
			   TraceLevel::DETAIL,
			   "Entering Windows_Compression_Dump_Algorithm::process" );
      ...
      try
	{
	  ...
	  if ( reader32_obj.support_File_Type() )
	    {
	      output << process_File ( compression_id, reader32_obj );
	    }
	  else
	    {
		...
		{
		  output << process_File ( compression_id, reader64_obj );
		}
	    }
	}
      catch ( std::exception &e )
	{
      ...
      Trace::write_Trace ( TraceArea::GRNN_OPTIMIZER,
			   TraceLevel::DETAIL,
			   "Exiting Windows_Compression_Dump_Algorithm::process" );
						   ...
						   reverse::wpef_module::Reader_32& reader32_obj )
    {
      Trace::write_Trace ( TraceArea::GRNN_OPTIMIZER,
			   TraceLevel::DETAIL,
			   "Entering Windows_Compression_Dump_Algorithm::process_File (32-bit)" );
	...
	% classifier::Windows_Input_Tag_Names::TAG_PE_OPT_IMAGE_SIZE << std::endl;
      ...
      Trace::write_Trace ( TraceArea::GRNN_OPTIMIZER,
			   TraceLevel::DETAIL,
			   "Exiting Windows_Compression_Dump_Algorithm::process_File (32-bit)" );
						   ...
						   reverse::wpef_module::Reader_64& reader64_obj )
    {
      Trace::write_Trace ( TraceArea::GRNN_OPTIMIZER,
			   TraceLevel::DETAIL,
			   "Entering Windows_Compression_Dump_Algorithm::process_File (64-bit)" );
	...
	% classifier::Windows_Input_Tag_Names::TAG_PE_OPT_IMAGE_SIZE << std::endl;
      ...
      Trace::write_Trace ( TraceArea::GRNN_OPTIMIZER,
			   TraceLevel::DETAIL,
			   "Exiting Windows_Compression_Dump_Algorithm::process_File (64-bit)" );

      return output.str();
    }

    void
    Windows_Compression_Dump_Algorithm::find_Files ( const boost::filesystem::path& dirpath,
						 std::vector<std::string>& output_files )
    {
      Trace::write_Trace ( TraceArea::GRNN_OPTIMIZER,
			   TraceLevel::DETAIL,
			   "Entering Windows_Compression_Dump_Algorithm::fine_Files" );
      ...
      if ( exists ( dirpath ) )
	{
      ...
      Trace::write_Trace ( TraceArea::GRNN_OPTIMIZER,
			   TraceLevel::DETAIL,
			   "Exiting Windows_Compression_Dump_Algorithm::fine_Files" );
    }

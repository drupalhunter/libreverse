...
{
    infrastructure::Component_Factory::ptr_t fact_ptr =
        Component_Factory::get_Factory();

    boost::shared_ptr<Null_Component> comp_ptr =
        boost::dynamic_pointer_cast<Null_Component>
        ( fact_ptr->get_Null_Component ( Component::SOURCE_ID ) );
...
void test_one_node_three_graphs ()
{
    ...
    (*master_map)["analysis"] = form_parse_ref.get_Graph ( "two_node.xml",
                                                           PWD_PREFIX
                                                           "/libreverse/api/tests" );

...
namespace libreverse { namespace component {
    ...
    std::string
    Arch_Type_Detector_Elf32_Algorithm::run ( io_types::File_ID::const_ptr_t file_ptr )
    {

#ifdef LIBREVERSE_DEBUG
      Trace::write_Trace ( TraceArea::COMPONENTS,
			   TraceLevel::DETAIL,
			   "Entering Arch_Type_Detector_Elf32_Algorithm::run" );
#endif /* LIBREVERSE_DEBUG */
      ...
      Trace::write_Trace ( TraceArea::COMPONENTS,
			   TraceLevel::DETAIL,
			   "Exiting Arch_Type_Detector_Elf32_Algorithm::run" );
#endif /* LIBREVERSE_DEBUG */

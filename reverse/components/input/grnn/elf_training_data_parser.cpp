...
namespace libreverse
{
  namespace classifier
  {
    Elf_Training_Data_Parser::Elf_Training_Data_Parser ()
      : m_training_data ( new classifier::Training_Data<Elf_Training_Data> () )
    {
    ...
    void
    Elf_Training_Data_Parser::startElement ( const std::string& element_name,
    ...
    void
    Elf_Training_Data_Parser::charData ( const std::string& element_value )
    {
    ...
    void
    Elf_Training_Data_Parser::endElement ( const std::string& element_name )
    {
	  ...
	  m_training_data = alloc::Create::shared_pointer < Training_Data<Elf_Training_Data> > ();
        }
    ...
    classifier_types::Training_Set<Elf_Training_Data>::Data_List_t&

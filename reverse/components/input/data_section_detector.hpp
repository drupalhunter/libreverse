...
#ifndef DATA_SECTION_DECTECTOR_H
#define DATA_SECTION_DECTECTOR_H
...
namespace reverse { namespace component {
    ...
    class Data_Section_Detector : public infrastructure::Component,
                                  ...
                                  public boost::enable_shared_from_this<Data_Section_Detector>
    {
    public:

        explicit Data_Section_Detector ();
	  
        explicit Data_Section_Detector ( infrastructure_types::Component_State::ptr_t state_ptr );

        Data_Section_Detector ( Data_Section_Detector const& rhs );

        virtual ~Data_Section_Detector();

        Data_Section_Detector& operator= ( Data_Section_Detector const& rhs );

        void swap ( Data_Section_Detector& rhs );

...
#include "io/input/File_Readers/Elf/Elf_File_Header_32.h"
...
namespace libreverse { namespace component {
    ...
    Entry_Point_Detector_Elf32_Algorithm::run ( io_types::File_ID::const_ptr_t file_ptr )
    {
      ...
      Trace::write_Trace ( TraceArea::COMPONENTS,
			   TraceLevel::DETAIL,
			   "Entering Entry_Point_Detector_Elf32_Algorithm::run" );
#endif /* LIBREVERSE_DEBUG */
      ...
      elf_types::Elf_File_Header_32::const_ptr_t elf_file_hdr_ptr = elf_hdr_ptr->get_File_Header ();
      ...
      Trace::write_Trace ( TraceArea::COMPONENTS,
			   TraceLevel::DETAIL,
			   "Exiting Entry_Point_Detector_Elf32_Algorithm::run" );
#endif /* LIBREVERSE_DEBUG */

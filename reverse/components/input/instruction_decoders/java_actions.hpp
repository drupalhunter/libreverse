...
#ifndef REVERSE_COMPONENTS_INPUT_INSTRUCTION_DECODERS_JAVA_ACTIONS_HPP_INCLUDED
#define REVERSE_COMPONENTS_INPUT_INSTRUCTION_DECODERS_JAVA_ACTIONS_HPP_INCLUDED
...
namespace reverse {
  ...
  namespace components {
	...
	public:
	  ...
	  virtual void set_current_basic_block ( boost::shared_ptr<data_container::basic_block> ) = 0;
...
#endif // #ifndef REVERSE_COMPONENTS_INPUT_INSTRUCTION_DECODERS_JAVA_ACTIONS_HPP_INCLUDED

...
#ifndef DATA_SECTION_DETECTOR_ALGORITHM_H
...
namespace reverse {
    ...
    namespace component {
        ...
        class Data_Section_Detector_Algorithm {
        public:

            typedef boost::shared_ptr<Data_Section_Detector_Algorithm> ptr_t;
...
#endif /* DATA_SECTION_DETECTOR_ALGORITHM_H */

...
namespace libreverse { namespace component {
    ...
    Data_Section_Detector_WPEF32_Algorithm::run ( io_types::File_ID::const_ptr_t file_ptr )
    {

#ifdef LIBREVERSE_DEBUG
      Trace::write_Trace ( TraceArea::COMPONENTS,
			   TraceLevel::DETAIL,
			   "Entering Data_Section_Detector_WPEF32_Algorithm::run" );
#endif /* LIBREVERSE_DEBUG */
      ...
      Trace::write_Trace ( TraceArea::COMPONENTS,
			   TraceLevel::DETAIL,
			   "Exiting Data_Section_Detector_WPEF32_Algorithm::run" );
#endif /* LIBREVERSE_DEBUG */

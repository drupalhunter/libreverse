...
#ifndef ENTRY_POINT_DECTECTOR_H
#define ENTRY_POINT_DECTECTOR_H
...
namespace libreverse { namespace component {
    ...
    class Entry_Point_Detector : public infrastructure::Component,
                                 ...
                                 public boost::enable_shared_from_this<Entry_Point_Detector>
    {
    public:

        explicit Entry_Point_Detector ();
	  
        explicit Entry_Point_Detector ( infrastructure_types::Component_State::ptr_t state_ptr );

        Entry_Point_Detector ( Entry_Point_Detector const& rhs );

        virtual ~Entry_Point_Detector();

        Entry_Point_Detector& operator= ( Entry_Point_Detector const& rhs );

        void swap ( Entry_Point_Detector& rhs );

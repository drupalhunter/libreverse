...
#include "Entry_Point_Detector_WPEF64_Algorithm.h"
...
#include "io/input/File_Readers/Windows_PE/PE_Header_64.h"
#include "io/input/File_Readers/Windows_PE/PE_Optional_Header_64.h"
...
namespace libreverse { namespace component {
    ...
    Entry_Point_Detector_WPEF64_Algorithm::run ( io_types::File_ID::const_ptr_t file_ptr )
    {

#ifdef LIBREVERSE_DEBUG
      Trace::write_Trace ( TraceArea::COMPONENTS,
			   TraceLevel::DETAIL,
			   "Entering Entry_Point_Detector_WPEF64_Algorithm::run" );
#endif /* LIBREVERSE_DEBUG */
      ...
      wpef_types::Header_64::ptr_t file_hdr_ptr = file_reader_ptr->get_Header();
      wpef_types::PE_Header_64::const_ptr_t pe_hdr_ptr = file_hdr_ptr->get_PE_Header();
      wpef_types::PE_Optional_Header_64::ptr_t pe_opt_hdr_ptr = pe_hdr_ptr->get_Optional_Header();
      ...
      Trace::write_Trace ( TraceArea::COMPONENTS,
			   TraceLevel::DETAIL,
			   "Exiting Entry_Point_Detector_WPEF64_Algorithm::run" );
#endif /* LIBREVERSE_DEBUG */
